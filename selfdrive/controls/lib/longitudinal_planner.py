...
A_CRUISE_MIN = -1.2
A_CRUISE_MAX_VALS = [1.5, 2.4, 2.4, 2.4, 1.45, 1.05, .78, .58, .34, .092]
...
A_CRUISE_MAX_VALS_TOYOTA = [1.5, 2.4, 2.4, 2.4, 1.45, 1.05, .78, .58, .31, .11]  # Sets the limits of the planner accel, PID may exceed
