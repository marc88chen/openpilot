...
A_CRUISE_MIN_VALS = [-0.005,  -0.008,  -0.3,  -0.7,  -0.7]
...
A_CRUISE_MAX_VALS_TOYOTA = [2.0, 2.4, 2.4, 1.25, 1.05, 0.75, 0.58, 0.4,  0.31, 0.11]  # Sets the limits of the planner accel, PID may exceed
