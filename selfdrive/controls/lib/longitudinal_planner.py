...
A_CRUISE_MIN_VALS =    [-0.0007, -0.0009, -0.16, -0.36, -0.6, -0.6]
A_CRUISE_MIN_BP =      [0.,      1.,    2.,    16.,   28.,  42.]
A_CRUISE_MIN_VALS_DF = [-0.20,  -0.20,  -0.40,  -0.40,  -0.16,  -0.28,  -0.38, -0.6, -0.6]
A_CRUISE_MIN_BP_DF =   [0.,    0.04,   0.12,    0.30,   0.35,   5.,     16.,   28.,  42.]
A_CRUISE_MAX_VALS_DF =     [1.5, 2.4, 2.4, 2.2, 1.56, 1.23, .88, .660, .46, .328, .09]  # Sets the limits of the planner accel, PID may exceed
