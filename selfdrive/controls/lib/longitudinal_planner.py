...
A_CRUISE_MIN_VALS = [-0.003,  -0.14,  -0.28, -0.6,  -0.6]
A_CRUISE_MIN_BP =   [0.,     8.,     16.,   28.,   42.]
A_CRUISE_MAX_VALS_DF =     [2.4, 2.4, 2.0, 1.65, 1.45, .96, .78, .58, .38, .11]  # Sets the limits of the planner accel, PID may exceed
