...
A_CRUISE_MIN_VALS =    [-0.0009, -0.16, -0.36, -0.6, -0.6]
A_CRUISE_MIN_BP =      [0.,      8.,    16.,   28.,  42.]
A_CRUISE_MIN_VALS_DF = [-0.0009, -0.001, -0.10, -0.28, -0.6, -0.6]
A_CRUISE_MIN_BP_DF =   [0.,      1.,     8.,    16.,   28.,  42.]
A_CRUISE_MAX_VALS_DF =     [1.5, 2.4, 2.4, 2.1, 1.548, 1.221, .863, .660, .478, .328, .09]  # Sets the limits of the planner accel, PID may exceed
