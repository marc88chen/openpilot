...
A_CRUISE_MIN_VALS = [-0.001, -0.001,  -0.10, -0.28, -0.6, -0.6]
A_CRUISE_MIN_BP =   [0.,     1.,      8.,    16.,   28.,  42.]
A_CRUISE_MAX_VALS_DF =     [1.5, 2.4, 2.4, 2.1, 1.555, 1.225, .8665, .658, .478, .328, .09]  # Sets the limits of the planner accel, PID may exceed
A_CRUISE_MAX_BP_DF =       [0.,  0.3, 3.,  6.,   8.,   11.,  15.,  20., 25., 30., 55.] 
