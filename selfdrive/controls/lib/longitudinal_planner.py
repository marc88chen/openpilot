...
A_CRUISE_MIN = -1.2
A_CRUISE_MAX_VALS = [2.4, 2.0, 0.8, 0.3]
A_CRUISE_MAX_BP = [0., 10.0, 25., 40.]
A_CRUISE_MIN_VALS = [-0.004,  -0.14,  -0.28, -0.6,  -0.6]
A_CRUISE_MIN_BP =   [0.,     8.,     16.,   28.,   42.]
A_CRUISE_MAX_VALS_DF =     [2.4, 2.4, 1.9, 1.65, 1.45, .96, .78, .58, .38, .11]  # Sets the limits of the planner accel, PID may exceed
A_CRUISE_MAX_BP_DF =       [0.,  0.5, 6.,  8.,  11., 15.,   20., 25., 30., 55.]
A_CRUISE_MAX_VALS_TOYOTA = [2.4, 2.4, 2.4, 2.0, 1.45, 1.05, .78, .58,  0.34, 0.11]  # Sets the limits of the planner accel, PID may exceed
