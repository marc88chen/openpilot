...
A_CRUISE_MIN = -1.2
A_CRUISE_MAX_VALS = [1.6, 2.4, 2.4, 2.4, 1.5, 1.05, .78, .58, .34, .092]
A_CRUISE_MAX_BP = [0.,  0.5, 6.,  8.,  11., 15.,   20., 25., 30., 55.]
A_CRUISE_MIN_VALS = [-0.01,  -0.05,  -0.6,  -0.7,  -0.7]
A_CRUISE_MIN_BP =   [0.,     0.2,   5.0,    28.,   42.]
A_CRUISE_MAX_VALS_DF =     [1.6, 2.4, 2.4, 2.4, 1.5, 1.05, .78, .58, .34, .092]  # Sets the limits of the planner accel, PID may exceed
A_CRUISE_MAX_BP_DF =       [0.,  0.5, 6.,  8.,  11., 15.,   20., 25., 30., 55.]
A_CRUISE_MAX_VALS_TOYOTA = [1.6, 2.4, 2.4, 2.4, 1.5, 1.05, .78, .58, .31, .11]  # Sets the limits of the planner accel, PID may exceed
