...
A_CRUISE_MIN_VALS = [-0.0007, -0.001,  -0.10, -0.28, -0.6, -0.6]
A_CRUISE_MIN_BP =   [0.,     1.,      8.,    16.,   28.,  42.]
A_CRUISE_MAX_VALS_DF =     [1.54, 2.4, 2.4, 2.1, 1.548, 1.221, .863, .658, .478, .328, .09]  # Sets the limits of the planner accel, PID may exceed
