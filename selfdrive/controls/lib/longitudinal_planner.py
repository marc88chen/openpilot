...
A_CRUISE_MIN_VALS_DF = [-0.1,  -0.35,  -0.14,  -0.14, -0.28, -0.6, -0.6]
A_CRUISE_MIN_BP_DF =   [0.,    0.2,    1.0,    8.,    16.,   28.,  42.]
A_CRUISE_MAX_VALS_DF =     [1.5, 2.4, 2.4, 2.1, 1.56, 1.23, .88, .660, .46, .328, .09]  # Sets the limits of the planner accel, PID may exceed
